...
static void
reverse_range_equals_test(void)
{
    assert(reverse_range_equals(reverse_range_make(0, 0),
                                reverse_range_make(0, 0)));
    assert(reverse_range_equals(reverse_range_make(42, 42),
                                reverse_range_make(0, 0)));
    
    assert(reverse_range_equals(reverse_range_make(10, -10),
                                reverse_range_make(10, -10)));
    assert(reverse_range_equals(reverse_range_make(-1, -10),
                                reverse_range_make(-1, -10)));
    assert(reverse_range_equals(reverse_range_make(10, 1),
...
reverse_range_expand_test(void)
{
    ...
    assert(reverse_range_equals(reverse_range_make(1, -1), reverseRange));
    
    reverseRange = reverse_range_expand(reverseRange, 2);
    
    assert(reverse_range_equals(reverse_range_make(3, -3), reverseRange));
...
reverse_range_extend_to_include_value_test(void)
{
    ...
    assert(reverse_range_equals(reverse_range_make(1, 0), reverseRange));
    
    reverseRange = reverse_range_extend_to_include_value(reverseRange, -1);
    
    assert(reverse_range_equals(reverse_range_make(1, -2), reverseRange));
    
    reverseRange = reverse_range_extend_to_include_value(reverseRange, 42);
    
    assert(reverse_range_equals(reverse_range_make(42, -2), reverseRange));
}
