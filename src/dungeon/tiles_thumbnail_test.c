...
static void
tiles_thumbnail_walls_alloc_test_for_no_tiles(void)
{
    int tiles_count = 0;
    struct tile **tiles = calloc_or_die(tiles_count, sizeof(struct tile *));
...
static void
tiles_thumbnail_walls_alloc_test_for_one_tiles(void)
{
    int tiles_count = 1;
    struct tile **tiles = calloc_or_die(tiles_count, sizeof(struct tile *));
    tiles[0] = tile_alloc(point_make(0, 0, 1), tile_type_empty);
    tiles[0]->walls.south = wall_type_solid;
    tiles[0]->walls.west = wall_type_door;
...
static void
tiles_thumbnail_walls_alloc_test_for_two_tiles(void)
{
    int tiles_count = 2;
    struct tile **tiles = calloc_or_die(tiles_count, sizeof(struct tile *));
    tiles[0] = tile_alloc(point_make(0, 0, 1), tile_type_empty);
    ...
    tiles[1] = tile_alloc(point_make(1, 0, 1), tile_type_filled);
    tiles[1]->walls.south = wall_type_door;
    tiles[1]->walls.west = wall_type_none;
...
static void
tiles_thumbnail_walls_alloc_test_for_three_tiles(void)
{
    int tiles_count = 3;
    struct tile **tiles = calloc_or_die(tiles_count, sizeof(struct tile *));
    tiles[0] = tile_alloc(point_make(0, 0, 1), tile_type_empty);
    tiles[0]->walls.south = wall_type_none;
    tiles[0]->walls.west = wall_type_solid;
    tiles[1] = tile_alloc(point_make(1, 0, 1), tile_type_filled);
    tiles[1]->walls.south = wall_type_secret_door;
    tiles[1]->walls.west = wall_type_none;
    tiles[2] = tile_alloc(point_make(0, -1, 1), tile_type_stairs_up);
    tiles[2]->walls.south = wall_type_solid;
    tiles[2]->walls.west = wall_type_door;
...
static void
tiles_thumbnail_walls_alloc_test_for_each_tile_type(void)
{
    int tiles_count = 5;
    struct tile **tiles = calloc_or_die(tiles_count, sizeof(struct tile *));
    tiles[0] = tile_alloc(point_make(-1, -1, 1), tile_type_empty);
    ...
    tiles[3] = tile_alloc(point_make( 0,  0, 1), tile_type_filled);
    tiles[3]->walls.south = wall_type_none;
    tiles[3]->walls.west = wall_type_none;
    tiles[4] = tile_alloc(point_make(-1,  1, 1), tile_type_filled);
    tiles[4]->walls.south = wall_type_door;
    tiles[4]->walls.west = wall_type_door;
...
tiles_thumbnail_test(void)
{
    ...
    tiles_thumbnail_walls_alloc_test_for_no_tiles();
    tiles_thumbnail_walls_alloc_test_for_one_tiles();
    tiles_thumbnail_walls_alloc_test_for_two_tiles();
    tiles_thumbnail_walls_alloc_test_for_three_tiles();
    tiles_thumbnail_walls_alloc_test_for_each_tile_type();
}
